 ...
 */
public class FileConnectionCleanupImpl implements FileConnectionCleanup {
    ...
    public boolean suiteHasPrivateData(int suiteId) {
        /*
         * IMPL_NOTE: to write sensible implementation of the method.
         *
         * Hint: declare new jsr75_suite_remove_data_exists function in
         * fcCleanup.h similar to jsr75_suite_remove_cleanup then implement it
         * over pcsl as well as over javacall.
         */
        return true;
    }
