...
static int
extract_item_data(KNIDECLARGS jobject data_array, unsigned char *data_buffer,
                    int data_buffer_len, jobject categories,
                    jchar *cats_buffer, int cats_buffer_len) {
    int data_length;
    int cats_length;
...
static int getIndexOfDelimiter(jchar* string) {
    jchar* current;
    
    for (current = string;
         *current != 0 && *current != JSR75_PIM_STRING_DELIMITER;
         current++) {
    }
    return current - string;
}

KNIEXPORT KNI_RETURNTYPE_OBJECT KNIDECL(com_sun_j2me_pim_PIMProxy_getDefaultListName) {
    ...
    if (output_buffer != NULL) {
        if (jsr75_pim_get_lists(listType,
                                output_buffer, OUT_BUFFER_LEN) == JSR75_STATUSCODE_OK) {
            int defaultNameLength = getIndexOfDelimiter(output_buffer);
    
            if (defaultNameLength != -1) {
                KNI_NewString(output_buffer, defaultNameLength, objectHandle);
            }
        }
    }
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_getListNamesCount0) {
    jsr75_pim_type listType;
    jchar *current;
    int namesCount = 0;
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_listOpen0) {
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_getNextItemDescription0) {
    int listHandle;
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_listClose0) {
    int listHandle;
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_getNextItemData0) {
...
KNIEXPORT KNI_RETURNTYPE_OBJECT KNIDECL(com_sun_j2me_pim_PIMProxy_getItemCategories0) {
    jsr75_handle itemHandle;
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_commitItemData0) {
    ...
    current_buffer_state = data_buffer_empty;
    if (extract_item_data(KNIPASSARGS dataArray, data_buffer,
                            DATA_BUFFER_LEN - CATEGORIES_MAX_LEN,
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_addItem0) {
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_removeItem0) {
    jsr75_handle listHandle, itemHandle;
    JSR75_STATUSCODE result;
...
KNIEXPORT KNI_RETURNTYPE_OBJECT KNIDECL(com_sun_j2me_pim_PIMProxy_getListCategories0) {
    jsr75_handle listHandle;
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_getListMaxCategories0) {
    jsr75_handle listHandle;
    int max_categories;
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_addListCategory0) {
    jsr75_handle listHandle;
    JSR75_STATUSCODE result = JSR75_STATUSCODE_FAIL;
    int             cat_len;
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_deleteListCategory0) {
    jsr75_handle listHandle;
    JSR75_STATUSCODE result = JSR75_STATUSCODE_FAIL;
    int             cat_len;
...
KNIEXPORT KNI_RETURNTYPE_BOOLEAN KNIDECL(com_sun_j2me_pim_PIMProxy_renameListCategory0) {
    jsr75_handle listHandle;
    JSR75_STATUSCODE result = JSR75_STATUSCODE_FAIL;
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_getFieldsCount0) {
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_getFieldLabelsCount0) {
    jsr75_pim_field *fields;
...
KNIEXPORT KNI_RETURNTYPE_VOID KNIDECL(com_sun_j2me_pim_PIMProxy_getFields0) {
    jsr75_pim_field *fields;
    int descArraySize;
    int labelArraySize;
    int i, j;
...
KNIEXPORT KNI_RETURNTYPE_INT KNIDECL(com_sun_j2me_pim_PIMProxy_getAttributesCount0) {
...
KNIEXPORT KNI_RETURNTYPE_VOID KNIDECL(com_sun_j2me_pim_PIMProxy_getAttributes0) {
    jsr75_pim_field_attribute *attributes;
    int attrArraySize;
    int i;
    jchar *str;
    ...
    if ((jsr75_handle)KNI_GetParameterAsInt(1) != last_handle ||
        ...
        if (attrArraySize < attributesCount) {
            ...
            KNI_FindClass("com/sun/j2me/pim/PIMAttribute", attrClass);
