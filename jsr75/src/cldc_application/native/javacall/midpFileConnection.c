...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_delete()
{
    ...
    else
    {
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
            ...
            {
                if (JAVACALL_OK == javacall_fileconnection_dir_exists(fileName_data))
                {            
                    if (JAVACALL_OK != javacall_fileconnection_delete_dir(fileName_data))
                    {
            ...
            if (PCSL_STRING_PARAMETER_ERROR(fileName)
             || PCSL_STRING_PARAMETER_ERROR(newFileName)) {
                ...
                */
                ...
                {
                    existStatus = javacall_fileconnection_dir_exists(newFileName_data);
                }
                ...
                else
                {
                    if (JAVACALL_OK == javacall_fileconnection_dir_exists(fileName_data))
                    {
                        renameStatus = javacall_fileconnection_rename_dir(fileName_data,
                                newFileName_data);
                    }
                    else
                    {
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_mkdir()
{
    ...
    {    
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
             ...
             */
            if (JAVACALL_OK != javacall_fileconnection_create_dir(fileName_data))
            {
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_exists()
{
    ...
    else
    {
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
            ...
            {
                exist = javacall_fileconnection_dir_exists(fileName_data);
            }
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_isDirectory()
{
    ...
    else
    {
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
            ...
            res = (JAVACALL_OK == javacall_fileconnection_dir_exists(fileName_data)) ? KNI_TRUE : KNI_FALSE;
        }
        RELEASE_PCSL_STRING_DATA_AND_LENGTH
    }
    DEBUG_PRINT("File.isDirectory() <<\n");
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_canRead()
{
    ...
    {        
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
            ...
            status = javacall_fileconnection_is_readable(fileName_data, &value);
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_canWrite()
{
    ...
    {        
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
            ...
            status = javacall_fileconnection_is_writable(fileName_data, &value);
            res = (JAVACALL_OK == status && JAVACALL_TRUE == value) ? KNI_TRUE : KNI_FALSE;
        }
        RELEASE_PCSL_STRING_DATA_AND_LENGTH
    }
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_isHidden0()
{
    ...
    else
    {
        ...
        if (PCSL_STRING_PARAMETER_ERROR(fileName)) {
            ...
            status = javacall_fileconnection_is_hidden(fileName_data, &value);
            res = (JAVACALL_OK == status && JAVACALL_TRUE == value) ? KNI_TRUE : KNI_FALSE;
        }
        RELEASE_PCSL_STRING_DATA_AND_LENGTH
    }
                ...
                if (PCSL_STRING_OK != pcsl_string_append(pLongName, fileName)
                 ...
                 || PCSL_STRING_OK != pcsl_string_append_buf(pLongName, found_data, found_len)) {
                    ...
                    if (PCSL_STRING_PARAMETER_ERROR(pLongName)) {
                        ...
                        if (JAVACALL_OK == javacall_fileconnection_is_hidden(pLongName_data, &hidden))
                        {
                            if (JAVACALL_FALSE == hidden || JAVACALL_TRUE == includeHidden)
                            {
                                /* add trailing '/' if the file is a directory */
                                if (JAVACALL_OK == javacall_fileconnection_dir_exists(pLongName_data))
                                {
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_availableSize()
{
    ...
    else
    {
        ...
        if (PCSL_STRING_PARAMETER_ERROR(rootName)) {
            ...
            if (JAVACALL_OK != javacall_fileconnection_get_free_size(rootName_data, &res))
            {
                res = (jlong)(-1);
            }
        }
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_totalSize()
{
    ...
    else
    {
        ...
        if (PCSL_STRING_PARAMETER_ERROR(rootName)) {
            ...
            if (JAVACALL_OK != javacall_fileconnection_get_total_size(rootName_data, &res))
            {
                res = (jlong)(-1);
            }
        }
