    ...
    for ( ; ; ) {
        ...
        while (NULL != fileName) {
            ...
            if (PCSL_STRING_PARAMETER_ERROR(pDirEntry)) {
                ...
                res = javacall_fileconnection_dir_exists(pDirEntry_data);
            }
            RELEASE_PCSL_STRING_DATA_AND_LENGTH
            if (finish) {
                javacall_dir_close(listHandle);
            ...
            if (JAVACALL_OK == res) {
                ...
                if (PCSL_STRING_PARAMETER_ERROR(pDirEntry)) {
                    ...
                    javacall_fileconnection_set_writable(pDirEntry_data, JAVACALL_TRUE);
        ...
        if (PCSL_STRING_PARAMETER_ERROR(pSubDir)) {
            ...
            javacall_fileconnection_set_writable(pSubDir_data, JAVACALL_TRUE);
            res = javacall_fileconnection_delete_dir(pSubDir_data);
        }
        RELEASE_PCSL_STRING_DATA_AND_LENGTH
        if (JAVACALL_OK != res) {
            pcsl_string_free(pSubDir);
