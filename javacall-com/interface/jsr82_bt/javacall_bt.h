...
#define JAVACALL_BT_INVALID_HANDLE         (void *)-1

#define JAVACALL_BT_UUID_16                0x19
#define JAVACALL_BT_UUID_32                0x1A
#define JAVACALL_BT_UUID_128               0x1C
...
/**
 * @typedef javacall_bt_uuid
 * @brief Bluetooth UUID
 */
typedef struct {
     javacall_uint8 type;
     union {
         javacall_uint16  uuid16;
         javacall_uint32  uuid32;
         javacall_uint8   uuid128[16];
     } value;
} javacall_bt_uuid;
 ...
 *
 * This function should always peform asynchronously. Upon completion of the
 ...
 * @param handle a handle which could be used for searching interruption and
 *        service record attributes retrieving; this handle must not be null
 *
 * @retval <code>JAVACALL_OK</code> on success
 * @retval <code>JAVACALL_FAIL</code> on failure
 */
javacall_result javacall_bt_sdp_request(
        const javacall_bt_address addr,
 ...
 * @retval <code>JAVACALL_FAIL</code> on failure
 */
javacall_result javacall_bt_sdp_get_service(
