...
/*
 * Network monitor version of BTSPP protocol
 */

//public final class Protocol extends com.sun.midp.io.j2me.btspp.Protocol {
public final class Protocol extends com.sun.jsr082.bluetooth.btspp.Protocol {
	...
	checkForPermission( BluetoothPermission.BLUETOOTH_CLIENT);
        return new BTSPPNetmonConnection(url, mode);
    }
   ...
   // protected Connection serverConnection(SecurityToken token, int mode)
	 ...
	 checkForPermission(BluetoothPermission.BLUETOOTH_SERVER);
        return new BTSPPNetmonNotifier(url, mode);
    }
