...
public class SDPClient {
     ...
     */
    public SDPClient(String bluetoothAddress) throws IOException {
    ...
    public void close() throws IOException {
    	if (DEBUG) {
    		System.out.println("* SDPClient: finishing transactions");
    	}
        ...
        if (DEBUG) {
			System.out.println("* SDPClient: closing connection");
		}
		if (connection != null) {
        	connection.release();
        	connection = null;
        ...
        if (DEBUG) {
			System.out.println("* SDPClient: Canceling all receivers");
		}
		SDPClientReceiver.cancel();
        if (DEBUG) {
			System.out.println("* SDPClient: closed");
		}
    }
