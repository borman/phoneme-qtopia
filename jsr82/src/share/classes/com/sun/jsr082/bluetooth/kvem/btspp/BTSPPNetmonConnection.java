...
// was import com.sun.midp.io.j2me.btspp.BTSPPNotifierImpl;
...
// was public class BTSPPNetmonConnection extends com.sun.midp.io.j2me.btspp.BTSPPConnectionImpl
public class BTSPPNetmonConnection extends com.sun.jsr082.bluetooth.btspp.BTSPPConnectionImpl
{
    /*
    ...
    BTSPPNetmonConnection(BluetoothUrl url, int mode) throws IOException {
        super(url, mode, null);
    ...
    protected BTSPPNetmonConnection(BluetoothUrl url,
    ...
    protected int send0(byte[] outData, int offset, int len)
                        throws IOException {
        int sentBytes = 0;
        try {
    ...
    protected int receive0(byte[] inData, int offset, int length)
            throws IOException {
        try {
