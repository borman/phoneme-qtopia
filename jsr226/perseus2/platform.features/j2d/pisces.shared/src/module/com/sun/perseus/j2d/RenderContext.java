...
public class RenderContext implements TextRenderingProperties, ViewportProperties {
    ...
    protected static final int VIEWPORT_FILL_OPACITY_MASK =   
            0x0000FF00;    /* 15-14-13-12-11-10-9-8 */
    ...
    /**
     * Color used for viewport fill operations
     *
     */
    ...
    //
    // viewport-fill opacity:    8 bits [0-200]
    // Total:                    8 bits
    //
    // Encoding:
    //
    // viewportFillOpacity: 15-14-13-12-11-10-09-08
    //
    protected int pack2 = INITIAL_PACK2;    

    protected static final int INITIAL_OPACITY_IMPL = 200;
    protected static final int INITIAL_VIEWPORT_FILL_OPACITY_IMPL = 200 << 8;
    protected static final int INITIAL_PACK2 = 
        INITIAL_OPACITY_IMPL
	|
	INITIAL_VIEWPORT_FILL_OPACITY_IMPL;
    ...
    public void restore(final RenderContext rcs) {
        this.fill = rcs.fill;
        this.viewportFill = rcs.viewportFill;
    ...
    /**
     * @param newOpacity the new value for the viewport-fill opacity 
     *        property. The input value is clamped to the [0, 1] range.
     *
     * @param newOpacity the new viewport-fill opacity value to set
     */
    public void setViewportFillOpacity(float newOpacity) {
        if (newOpacity < 0) {
            newOpacity = 0;
        } else if (newOpacity > 1) {
            newOpacity = 1;
        ...
        pack2 &= ~VIEWPORT_FILL_OPACITY_MASK;
        pack2 |= ((((int) (newOpacity * 200)) << 8) & VIEWPORT_FILL_OPACITY_MASK);
    }

    /**
     * @return the context's viewport-fill opacity property value
     */
    public float getViewportFillOpacity() {
        return ((pack2 & VIEWPORT_FILL_OPACITY_MASK) >> 8) / 200.0f;
    }

    /**
     * @return the context's viewport fill property value
     */
    ...
    /**
     * @param newFill the new value for the viewport fill property
     */
    public void setViewportFill(final PaintServer newFill) {
        this.viewportFill = newFill;
    }
