/*
 * $RCSfile: PiscesRenderGraphics.java,v $
 *
...
public abstract class PiscesRenderGraphics extends RenderContext {
    ...
    /**
     * Allows to horizontally shift the origin of coordinate space. Combines 
     * with transformation set via setTransform. The value is stored in Pisces 
     * coordinates.     
     */     
    protected int translateX;
    /**
     * Allows to vertically shift the origin of coordinate space. Combines 
     * with transformation set via setTransform. The value is stored in Pisces
     * coordinates.     
     */     
    ...
    public void setTransform(final Transform newTransform) {
        needSetTransform = (setTransform(newTransform, 
                                         transform,
                                         translateX,
                                         translateY) || needSetTransform);
        needSetTransform = true;
     }

    /**
     * Allows to override width and height values.
     * 
     ...
     * @param translateX additional horizontal shift to be applied to the 
     *          resulting Pisces transform, the value should be in Pisces 
     *          S15.16 format
     * @param translateY additional vertical shift to be applied to the
     *          resulting Pisces transform, the value should be in Pisces
     *          S15.16 format
    ...
    static boolean setTransform(final Transform newTransform,
        ...
        if (newTransform == null) {
            return setTransform(IDENTITY, transform, translateX, translateY);
        }
        ...
        /* apply an additional shift caused by translateX, translateY */
        int m02 = (int) (newTransform.m4 * 65536) + translateX;
        int m12 = (int) (newTransform.m5 * 65536) + translateY;
