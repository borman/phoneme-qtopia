...
public interface SVGConstants {
    ...
    String SVG_FOCUSABLE_ATTRIBUTE = "focusable";
    ...
    String SVG_INITIAL_VISIBILITY_ATTRIBUTE = "initialVisibility";
    ...
    String SVG_OVERLAY_ATTRIBUTE = "overlay";
    ...
    String SVG_SYNC_BEHAVIOR_ATTRIBUTE = "syncBehavior";
    String SVG_SYNC_BEHAVIOR_DEFAULT_ATTRIBUTE = "syncBehaviorDefault";
    String SVG_SYNC_MASTER_ATTRIBUTE = "syncMaster";
    String SVG_SYNC_TOLERANCE_ATTRIBUTE = "syncTolerance";
    String SVG_SYNC_TOLERANCE_DEFAULT_ATTRIBUTE = "syncToleranceDefault";
    ...
    String SVG_TRANSFORM_BEHAVIOR_ATTRIBUTE = "transformBehavior";
    ...
    String SVG_VIEWPORT_FILL_ATTRIBUTE = "viewport-fill";
    String SVG_VIEWPORT_FILL_OPACITY_ATTRIBUTE = "viewport-fill-opacity";
    ...
    String SVG_CAN_SLIP_VALUE = "canSlip";
    String SVG_DEFER_VALUE = "defer";
    ...
    String SVG_GEOMETRIC_VALUE = "geometric";
    String SVG_INDEFINITE_VALUE = "indefinite";
    String SVG_INDEPENDENT_VALUE = "independent";
    String SVG_LINEAR_VALUE = "linear";
    String SVG_LOCKED_VALUE = "locked";
    ...
    String SVG_TOP_VALUE = "top";
    String SVG_TRUE_VALUE = "true";
    String SVG_USER_SPACE_ON_USE_VALUE = "userSpaceOnUse";
    String SVG_WHEN_STARTED_VALUE = "whenStarted";
    String SVG_WHEN_NOT_ACTIVE_VALUE = "whenNotActive";

    // preserveAspectRatio "align" possibilities:
    String SVG_XMIN_YMIN_VALUE = "xMinYMin";
    String SVG_XMID_YMIN_VALUE = "xMidYMin";
    String SVG_XMAX_YMIN_VALUE = "xMaxYMin";
    String SVG_XMIN_YMID_VALUE = "xMinYMid";
    String SVG_XMID_YMID_VALUE = "xMidYMid";
    String SVG_XMAX_YMID_VALUE = "xMaxYMid";
    String SVG_XMIN_YMAX_VALUE = "xMinYMax";
    String SVG_XMID_YMAX_VALUE = "xMidYMax";
    String SVG_XMAX_YMAX_VALUE = "xMaxYMax";
