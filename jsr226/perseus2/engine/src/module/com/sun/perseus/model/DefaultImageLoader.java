/*
 * $RCSfile: DefaultImageLoader.java,v $
 *
...
public class DefaultImageLoader implements ImageLoader {
	...
	synchronized (loadingQueue) {
	    // Check if the thread associated with the loadingQueue
	    // has been terminated. If so create a new lodingQueue
            if(loadingQueue.getThread() == null) {
                loadingQueue =  RunnableQueue.createRunnableQueue(null);
                loadingQueue.resumeExecution();
            }
	}
