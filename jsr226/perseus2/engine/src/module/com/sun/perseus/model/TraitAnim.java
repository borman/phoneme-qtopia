 ...
 * animation, the new TraitAnimationNode's baseVal becomes the previous rootAnim.</p>
 * 
...
abstract class TraitAnim implements BaseValue {
     ...
     *        Should not be null.
     */
    void addAnimation(final TraitAnimationNode newAnim) {
        // Reject null values
        if (newAnim == null) {
            throw new NullPointerException();
        }
     ...
     *        should not be null. 
     */
    void removeAnimation(final TraitAnimationNode removedAnim) {
        // Reject null values.
        if (removedAnim == null) {
            throw new NullPointerException();
        }
        ...
        if (removedAnim == rootAnim) {
            ...
            if (removedAnim.baseVal == this) {
                ...
                rootAnim = (TraitAnimationNode) removedAnim.baseVal;
            }
        } else {
            if (rootAnim != null) {
                ...
                TraitAnimationNode curAnim = rootAnim;
