...
public class AnimateMotion extends AbstractAnimate {
    ...
    /**
     * Returns the value of the trait value as a String value. In SVG Tiny only
     * fixed traits can be obtained as String. Syntax of the returned vlaue
