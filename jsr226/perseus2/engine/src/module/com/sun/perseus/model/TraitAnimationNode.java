/*
 * $RCSfile: TraitAnimationNode.java,v $
 *
...
/**
 * The <code>TraitAnimationNode</code> class is the base class for all the
 * SVG animation elements. Note that this is <em>not</em> the base
 * class for media elements such as <code>&lt;audio&gt;</code> or
 * <code>&lt;video&gt;</code>.
 * 
 * The <code>TraitAnimationNode</code> class is the abstraction manipulated
 * by <code>TraitAnim</code> to compose the chain of currently 
 * active animations in priority order.
 * 
 * @version $Id: TraitAnimationNode.java,v 1.5 2006/06/29 10:47:29 ln156897 Exp $
 */
public abstract class TraitAnimationNode extends TimeAttributesNode 
     ...
     * document. This <code>TraitAnimationNode</code> will belong 
     ...
     */
    public TraitAnimationNode(final DocumentNode ownerDocument,
    ...
    /**
     * Validating a TraitAnimationNode consists of setting its target
    ...
    /**
     * TraitAnimationNode handles the xlink href attribute
     * 
    ...
    public String getTraitNSImpl(String namespaceURI, String name) throws DOMException {
        if (SVGConstants.XLINK_NAMESPACE_URI.equals(namespaceURI) && SVGConstants.SVG_HREF_ATTRIBUTE.equals(name)) {
            if (idRef == null) {
                return "";
            }
            return "#" + idRef;
    ...
    /**
     * TraitAnimationNode supports the xlink:href trait.
     * 
    ...
    protected boolean supportsTraitNS(final String namespaceURI, final String traitName) {
        if (SVGConstants.XLINK_NAMESPACE_URI.equals(namespaceURI) && SVGConstants.SVG_HREF_ATTRIBUTE.equals(traitName)) {
            return true;
        } else {
    ...
    /**
     * When an TraitAnimationNode is removed from the document tree, it needs
