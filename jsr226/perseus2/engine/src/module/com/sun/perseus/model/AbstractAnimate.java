/*
 * $RCSfile: AbstractAnimate.java,v $
 *
 ...
 */
public abstract class AbstractAnimate extends TraitAnimationNode {
    /**
    ...
    /**
     * Returns the value of the trait as a String value. In SVG Tiny only
     * fixed traits can be obtained as String. Syntax of the returned value
     * matches the syntax of the corresponding attribute. This element is
     * entirely analogue of
     * {@link org.w3c.dom.svg.SVGElement#getTraitNS getTraitNS} with
     ...
     *
     * @throws DOMException with NOT_SUPPORTED_ERR error code 
     * if the requested trait is null or not supported on this element.
     * @throws DOMException with TYPE_MISMATCH_ERR error code 
     * if requested computed trait's value can not be converted to
     * a String value (SVG Tiny only).
     */
     ...
     * if the requested trait is null or not supported on this element.
     * @throws DOMException with TYPE_MISMATCH_ERR error code
     * if the requested trait's value cannot be defined as a String value.
     * @throws DOMException with INVALID_ACCESS_ERR error code
     * if the specified value is null or invalid for the given trait.
     * @throws DOMException with NO_MODIFICATION_ALLOWED_ERR error code if
     * attempting to change readonly trait.
     */
    ...
    /**
     * Validating an Animate consists of:
