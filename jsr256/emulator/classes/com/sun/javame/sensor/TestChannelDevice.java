...
public abstract class TestChannelDevice extends ChannelDevice {
   ...
   /**
     ...
     */
    public TestChannelDevice(int numberSensor, int numberChannel, int sensorType) {
     ...
     */
    abstract void setTestData(Object[] data);
}
