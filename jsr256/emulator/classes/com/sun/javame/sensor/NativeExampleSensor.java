...
public class NativeExampleSensor extends SensorDevice {
     ...
     * @param sensorType - Sensor type. This is an ID needed only at the native level.
      */
     public NativeExampleSensor(int numberSensor, int numberChannel, int sensorType) {
     ...
     */
     public boolean initSensor() {
        return doInitSensor(sensorType);
    }
     ...
     */
     public boolean finishSensor() {
        return doFinishSensor(sensorType);
    }
    ...
    /**
     ...
     public boolean isAvailable() {
         return doIsAvailable(sensorType); // always available
     }
     ...
     *         was OK else false
     */
    private native boolean doInitSensor(int sensorType);
     ...
     *         was OK else false
     */
    private native boolean doFinishSensor(int sensorType);
    ...
    /**
      ...
      * @return true when channel device is available else false
      */
    private native boolean doIsAvailable(int sensorType);
