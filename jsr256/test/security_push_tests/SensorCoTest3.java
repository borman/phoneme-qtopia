 ...
 */
public class SensorCoTest3 extends MIDlet
	...
	try {
            ...
            System.out.println("OK: no security exception");
	} catch (SecurityException ex) { 
            System.out.println("Error: security exception when "+
                "javax.microedition.io.Connector.PrivateSensor permission is set");
	} catch (Exception ex) { 
