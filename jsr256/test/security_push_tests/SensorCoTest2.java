 ...
 */
public class SensorCoTest2 extends MIDlet
	...
	try {
            ...
            SensorConnection conn = 
                (SensorConnection)Connector.open(info[0].getUrl());
            System.out.println("Error: no security exception");
	} catch (SecurityException ex) { 
            System.out.println("OK: security exception when "+
                "no javax.microedition.io.Connector.PrivateSensor permission is set");
	} catch (Exception ex) { 
